...
const CommentItem = ({ history, comment, deleteComment, userLogin, post, getPost }) => {
	const { avatar, name, text, createdAt } = comment;
	useEffect(() => {
		return () => {
	...
	return (
		<div className='comment'>
			...
			<div className='comment__info'>
				...
				{userLogin.toString() === comment.user.toString() && (
