...
const LoginPage = ({ clearErrors, loadUser, loginUser,getProfile, auth: { errors } }) => {
	...
	return (
		<section className='register-page'>
			...
			<p className='register-page--para'>
				{' '}
				<Icon icon='user' size='3x' /> Sign To Your Account
			</p>
			...
			<p className='register-page--para__note'>
